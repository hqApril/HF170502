<?php
    ...
    class SeckillGoodDetailController extends Controller {
        ...
        public function __construct() {
            ...
            $this -> _model = new SeckillGoodDetailModel();
        }

        //转到商品详情页面
        public function toSeckillGoodDetailView() {
            $goodId = $_GET['g'];

            echo '<script>var goodId = '.$goodId.'</script>';

            include_once('./application/views/seckillgoodDetail.html');
        }
        ...
        public function addToOl() {
            ...
            $res = $this -> _model -> addToOl($userId, $goodId);
        }
    }
?>